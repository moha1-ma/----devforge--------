...
const proposalJson = JSON.stringify({ executionStatus: "review-only", headline: "منصة تعليمية", scope: ["لوحة مدير"], architecture: ["واجهة React"], websiteOutline: { title: "تعلم بثقة", pages: ["الرئيسية", "المسارات"], hierarchy: ["الرئيسية > المسارات"], primaryCta: "ابدأ التعلم" }, codeSketch: ["type Course = {}"], testPlan: ["اختبار العزل"], risks: ["الخصوصية"], approvalsRequired: ["اعتماد المالك"] });
